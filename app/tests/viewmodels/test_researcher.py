...
from src.viewmodels.researcher.researcher_list import ResearcherListViewModel
...
async def test_researcher_view_model_load():
    ...
    with patch(
        "src.models.researcher.ResearcherModel.load",
...
async def test_researcher_list_view_model_load():
    ...
    with patch(
        "src.models.researcher.ResearcherModel.list",
        new_callable=AsyncMock,
...
async def test_researcher_list_view_model_delete():
    ...
    with (
        patch(
            "src.models.researcher.ResearcherModel.delete", new_callable=AsyncMock
        ) as mock_delete,
        patch(
            "src.models.researcher.ResearcherModel.list",
            new_callable=AsyncMock,
